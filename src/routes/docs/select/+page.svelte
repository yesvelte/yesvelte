<script>
	...
	import SelectDisabledItems from './SelectDisabledItems.svelte'
</script>

<Page
	title="Select"
	description="Select component is used to let users choose from a predefined set of options.">
	<Doc title="Default">
	...
	<Doc title="Sizes">
		<Preview src="./SelectSizes.svelte">
	...
	<Doc title="Disabled Items">
		<Preview src="./SelectDisabledItems.svelte">
			<div class="custom-class"><SelectDisabledItems /></div>
		</Preview>
	</Doc>
</Page>
