...
<Page
	...
	<Doc
		title="Alert with avatar"
		description="Add an avatar to your alert modal to make it more personalized.">
	...
	<Doc
		title="Alert toggle"
		description="To show or hide the alert use the `open` property.">
